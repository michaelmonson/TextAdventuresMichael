        ...
        public string processPlayerName(string userEnteredName, string playerName)
        {
            ...
            switch (userEnteredName.Trim().ToUpper())
            {
                ...
                case "MARY":
                    ...
                    Console.Write($"{dl} Greetings {playerName}!  Thou art the great love of the brave Sir Orlando!  Welcome to this realm... may you find that which you seek!");
                    break;
                case "SARIAH":
                ...
                case "SAMUEL":
                    ...
                    Console.Write($"{dl} Ho Samuel!  The youth with three sisters!  I know your father well... wilt thou accept the challenge that has been placed before thee?");
                    break;
                default:
